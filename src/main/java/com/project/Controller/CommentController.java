...
@CrossOrigin(origins = "http://localhost:3000") //only changed for accessing comments to dash
@RestController
...
public class CommentController {
    ...
    public List<Comments> getFlaggedComments() {
        return commentRepository.findByFlaggedComments();
    }
	
    @PutMapping("/updateCommentText/{commentId}")
    public ResponseEntity<Void> updateCommentText(@PathVariable String commentId, @RequestBody Map<String, String> request) {
